...
class LecturerSchedule(ctk.CTkFrame):
    def __init__(self, master, lecturer_username=None, **kwargs):
        ...
        self.tb_frame_wrapper.grid(row=1, column=0, padx=20, pady=10, sticky="nwe")
        ...
        self.info_SubjectofSchedule.grid(row=0, column=3, columnspan=3, padx=10, pady=10, sticky="nws")
